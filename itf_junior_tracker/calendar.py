...
def parse_tournaments(html: str, debug_dir: Path) -> list[Tournament]:
    ...
    for a in soup.find_all("a", href=True):
        ...
        tournaments.append(Tournament(name=name, url=full_url, acceptance_url=acceptance_url(full_url), category=category))
...
def get_tournaments(start: date, debug_dir: Path) -> list[Tournament]:
    return parse_tournaments(fetch_calendar_html(start, debug_dir), debug_dir)
